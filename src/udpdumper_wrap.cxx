...
#define SWIGTYPE_p_UDPDumper swig_types[0]
...
#define SWIGV8_INIT udpdumper_initialize


SWIGV8_ClientData _exports_UDPDumper_clientData;


#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031710)
static void _wrap_delete_UDPDumper(v8::Persistent<v8::Value> object, void *parameter) {
  SWIGV8_Proxy *proxy = static_cast<SWIGV8_Proxy *>(parameter);
#elif (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031900)
  static void _wrap_delete_UDPDumper(v8::Isolate *isolate, v8::Persistent<v8::Value> object, void *parameter) {
    SWIGV8_Proxy *proxy = static_cast<SWIGV8_Proxy *>(parameter);
#elif (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < SWIGV8_SETWEAK_VERSION)
    static void _wrap_delete_UDPDumper(v8::Isolate *isolate, v8::Persistent< v8::Object> *object, SWIGV8_Proxy *proxy) {
#elif (V8_MAJOR_VERSION-0) < 5
      static void _wrap_delete_UDPDumper(const v8::WeakCallbackData<v8::Object, SWIGV8_Proxy> &data) {
        v8::Local<v8::Object> object = data.GetValue();
        SWIGV8_Proxy *proxy = data.GetParameter();
#else
        static void _wrap_delete_UDPDumper(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
          SWIGV8_Proxy *proxy = data.GetParameter();
#endif
          
          if(proxy->swigCMemOwn && proxy->swigCObject) {
            UDPDumper * arg1 = (UDPDumper *)proxy->swigCObject;
            delete arg1;
          }
          delete proxy;
...
static SwigV8ReturnValue _wrap_UDPDumper_WriteUDP(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  v8::Handle<v8::Value> jsresult;
  UDPDumper *arg1 = (UDPDumper *) 0 ;
  uint64_t arg2 ;
  uint32_t arg3 ;
  short arg4 ;
  uint32_t arg5 ;
  ...
  if(args.Length() != 7) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_UDPDumper_WriteUDP.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_UDPDumper, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "UDPDumper_WriteUDP" "', argument " "1"" of type '" "UDPDumper *""'"); 
  }
  arg1 = reinterpret_cast< UDPDumper * >(argp1);
  {
    res2 = SWIG_ConvertPtr(args[0], &argp2, SWIGTYPE_p_uint64_t,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "UDPDumper_WriteUDP" "', argument " "2"" of type '" "uint64_t""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "UDPDumper_WriteUDP" "', argument " "2"" of type '" "uint64_t""'");
    } else {
      arg2 = *(reinterpret_cast< uint64_t * >(argp2));
    }
  }
  {
    res3 = SWIG_ConvertPtr(args[1], &argp3, SWIGTYPE_p_uint32_t,  0 );
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "UDPDumper_WriteUDP" "', argument " "3"" of type '" "uint32_t""'"); 
    }  
    if (!argp3) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "UDPDumper_WriteUDP" "', argument " "3"" of type '" "uint32_t""'");
    } else {
  ...
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "UDPDumper_WriteUDP" "', argument " "4"" of type '" "short""'");
  } 
  arg4 = static_cast< short >(val4);
  {
    res5 = SWIG_ConvertPtr(args[3], &argp5, SWIGTYPE_p_uint32_t,  0 );
    if (!SWIG_IsOK(res5)) {
      SWIG_exception_fail(SWIG_ArgError(res5), "in method '" "UDPDumper_WriteUDP" "', argument " "5"" of type '" "uint32_t""'"); 
    }  
    if (!argp5) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "UDPDumper_WriteUDP" "', argument " "5"" of type '" "uint32_t""'");
    } else {
  ...
  if (!SWIG_IsOK(ecode6)) {
    SWIG_exception_fail(SWIG_ArgError(ecode6), "in method '" "UDPDumper_WriteUDP" "', argument " "6"" of type '" "short""'");
  } 
  arg6 = static_cast< short >(val6);
  res7 = SWIG_ConvertPtr(args[5], &argp7,SWIGTYPE_p_uint8_t, 0 |  0 );
  if (!SWIG_IsOK(res7)) {
    SWIG_exception_fail(SWIG_ArgError(res7), "in method '" "UDPDumper_WriteUDP" "', argument " "7"" of type '" "uint8_t *""'"); 
  }
  arg7 = reinterpret_cast< uint8_t * >(argp7);
  {
    res8 = SWIG_ConvertPtr(args[6], &argp8, SWIGTYPE_p_uint32_t,  0 );
    if (!SWIG_IsOK(res8)) {
      SWIG_exception_fail(SWIG_ArgError(res8), "in method '" "UDPDumper_WriteUDP" "', argument " "8"" of type '" "uint32_t""'"); 
    }  
    if (!argp8) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "UDPDumper_WriteUDP" "', argument " "8"" of type '" "uint32_t""'");
    } else {
      arg8 = *(reinterpret_cast< uint32_t * >(argp8));
    }
  }
  (arg1)->WriteUDP(arg2,arg3,arg4,arg5,arg6,arg7,arg8);
...
static SwigV8ReturnValue _wrap_UDPDumper_Close(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_UDPDumper_Close.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_UDPDumper, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "UDPDumper_Close" "', argument " "1"" of type '" "UDPDumper *""'"); 
  }
  arg1 = reinterpret_cast< UDPDumper * >(argp1);
  (arg1)->Close();
  jsresult = SWIGV8_UNDEFINED();
...
static SwigV8ReturnValue _wrap_new_veto_UDPDumper(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIG_exception(SWIG_ERROR, "Class UDPDumper can not be instantiated");
fail:
  SWIGV8_RETURN(SWIGV8_UNDEFINED());
}


static SwigV8ReturnValue _wrap_create(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  v8::Handle<v8::Value> jsresult;
  UDPDumper *result = 0 ;
  
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_create.");
  
  result = (UDPDumper *)create();
  jsresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_UDPDumper, 0 |  0 );
...
static swig_type_info _swigt__p_UDPDumper = {"_p_UDPDumper", "UDPDumper *|p_UDPDumper", 0, 0, (void*)0, 0};
...
#endif
{
  ...
  /* Name: _exports_UDPDumper, Type: p_UDPDumper, Dtor: _wrap_delete_UDPDumper */
v8::Handle<v8::FunctionTemplate> _exports_UDPDumper_class = SWIGV8_CreateClassTemplate("_exports_UDPDumper");
SWIGV8_SET_CLASS_TEMPL(_exports_UDPDumper_clientData.class_templ, _exports_UDPDumper_class);
_exports_UDPDumper_clientData.dtor = _wrap_delete_UDPDumper;
if (SWIGTYPE_p_UDPDumper->clientdata == 0) {
  SWIGTYPE_p_UDPDumper->clientdata = &_exports_UDPDumper_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_UDPDumper_class, "WriteUDP", _wrap_UDPDumper_WriteUDP);
SWIGV8_AddMemberFunction(_exports_UDPDumper_class, "Close", _wrap_UDPDumper_Close);
  ...
  /* class instances */
  /* Class: UDPDumper (_exports_UDPDumper) */
v8::Handle<v8::FunctionTemplate> _exports_UDPDumper_class_0 = SWIGV8_CreateClassTemplate("UDPDumper");
_exports_UDPDumper_class_0->SetCallHandler(_wrap_new_veto_UDPDumper);
_exports_UDPDumper_class_0->Inherit(_exports_UDPDumper_class);
_exports_UDPDumper_class_0->SetHiddenPrototype(true);
v8::Handle<v8::Object> _exports_UDPDumper_obj = _exports_UDPDumper_class_0->GetFunction();


  /* add static class functions and variables */
  SWIGV8_AddStaticFunction(exports_obj, "create", _wrap_create);


  /* register classes */
  exports_obj->Set(SWIGV8_SYMBOL_NEW("UDPDumper"), _exports_UDPDumper_obj);
...
NODE_MODULE(udpdumper, udpdumper_initialize)
#endif
